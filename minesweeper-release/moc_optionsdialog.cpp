...
**
** Created: Sat Jan 5 00:40:04 2013
...
QT_MOC_LITERAL(6, 48, 16),
QT_MOC_LITERAL(7, 65, 22),
QT_MOC_LITERAL(8, 88, 7),
QT_MOC_LITERAL(9, 96, 18),
QT_MOC_LITERAL(10, 115, 17),
QT_MOC_LITERAL(11, 133, 2)
    },
    "OptionsDialog\0settings_changed\0\0rows\0"
    "cols\0mines\0language_changed\0"
    "askMark_status_changed\0enabled\0"
    "setDisabledCustoms\0setEnabledCustoms\0"
    "ok\0"
};
...
void OptionsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->settings_changed((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        case 1: _t->language_changed((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->askMark_status_changed((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: _t->setDisabledCustoms(); break;
        case 4: _t->setEnabledCustoms(); break;
        case 5: _t->ok(); break;
        default: ;
        }
        ...
        {
            typedef void (OptionsDialog::*_t)(int , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsDialog::settings_changed)) {
                *result = 0;
            }
        }
        {
            typedef void (OptionsDialog::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsDialog::language_changed)) {
                *result = 1;
            }
        }
        {
            typedef void (OptionsDialog::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsDialog::askMark_status_changed)) {
                *result = 2;
            }
        }
    }
...
// SIGNAL 0
void OptionsDialog::settings_changed(int _t1, int _t2, int _t3)
{
...
// SIGNAL 1
void OptionsDialog::language_changed(QString _t1)
{
...
// SIGNAL 2
void OptionsDialog::askMark_status_changed(bool _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };

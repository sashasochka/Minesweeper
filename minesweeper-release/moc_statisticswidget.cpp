...
**
** Created: Mon Jan 7 12:17:33 2013
...
struct qt_meta_stringdata_StatisticsWidget_t {
    QByteArrayData data[1];
    char stringdata[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_StatisticsWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_StatisticsWidget_t qt_meta_stringdata_StatisticsWidget = {
    {
...
const QMetaObject StatisticsWidget::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_StatisticsWidget.data,
      qt_meta_data_StatisticsWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StatisticsWidget.stringdata))
